...
import com.exalogic.inmeghschool.Adapters.AdminAdapters.AdminHolidayAdapter;
import com.exalogic.inmeghschool.Database.PreferencesManger;
import com.exalogic.inmeghschool.Models.AdminModels.NoticeBoard.AdminHolidays.Holiday;
    ...
    private void editholidayfinal() {
        try {
            ...
            if (UIUtil.isInternetAvailable(this)) {
                ...
                RetrofitAPI.getInstance(this).getApi().UpdateData(jsonObject, new Callback<JsonObject>() {
                    @Override
                    public void success(JsonObject object, Response response) {
                        ...
                        try {
                            ...
                            if (object.get("status").getAsInt() == Constants.SUCCESS) {
                                ...
                                Toast.makeText(AdminHoliday.this, "holiday updated successfully", Toast.LENGTH_SHORT).show();
                            }
