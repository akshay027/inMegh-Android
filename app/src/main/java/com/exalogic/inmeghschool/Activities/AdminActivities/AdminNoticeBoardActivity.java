...
import com.exalogic.inmeghschool.Adapters.AdminAdapters.AdminNoticeBoardAdapter;
import com.exalogic.inmeghschool.Database.PreferencesManger;
import com.exalogic.inmeghschool.Models.AdminModels.NoticeBoard.Notice;
    ...
    private void deleteMessage() {
        try {
            if (UIUtil.isInternetAvailable(this)) {
                ...
                RetrofitAPI.getInstance(this).getApi().creteNoticeBoard(jsonObject, new Callback<JsonObject>() {
                    @Override
                        ...
                        public void success(JsonObject jsonObj, Response response) {
                            ...
                            try {
                                ...
                                if (Constants.SUCCESS == jsonObj.get("status").getAsInt()) {
                                    ...
                                    Toast.makeText(getApplicationContext(), "Announcement created", Toast.LENGTH_SHORT).show();
                                }
