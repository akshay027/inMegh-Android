...
import com.exalogic.inmeghschool.Adapters.ParentAdapters.ParentSyllabusAdapter;
import com.exalogic.inmeghschool.Database.PreferencesManger;
import com.exalogic.inmeghschool.Models.ParentModels.ParentSyllabus.ParentSyllabus;
import com.exalogic.inmeghschool.Models.ParentModels.ParentSyllabus.ParentSyllabusResponse;
import com.exalogic.inmeghschool.Models.ParentModels.ParentSyllabus.Syllabu;
...
*/
 /*   private void spinData() {
    ...
    private void updateData(com.exalogic.inmegh.Models.ParentModels.ParentSyllabus.ParentSyllabus parentSyllabus) {
    ...
    private void startDownloadPdf(String path, String subject) {
        ...
        Uri uri = Uri.parse(Constants.HostImage + path);
