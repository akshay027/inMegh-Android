...
import com.exalogic.inmeghschool.Activities.ParentActivities.SchoolInfoImageviewActivity;
import com.exalogic.inmeghschool.Database.PreferencesManger;
import com.exalogic.inmeghschool.Models.TeacherModels.StudentInfor.StudentInformation;
...
public class SchoolinfoActivity extends AppCompatActivity {
    ...
    private void bindData(StudentInformation profile) {
        ...
        Log.e("image=============", Constants.HostImage + profile.getLogoFileName());
