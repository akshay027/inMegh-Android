package com.exalogic.inmeghschool.Adapters.ParentAdapters;
...
import com.exalogic.inmeghschool.Activities.ParentActivities.ParentObservation;
import com.exalogic.inmeghschool.Models.ParentModels.ParentObservation.StudentObservation;
...
/**
 * Created by Exalogic on 31-Aug-16.
 */
public class ParentObservationAdapter extends RecyclerView.Adapter<ParentObservationAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        Picasso.with(context).load(Constants.HostImage + teacherObservation.getImage()).resize(50, 50)
