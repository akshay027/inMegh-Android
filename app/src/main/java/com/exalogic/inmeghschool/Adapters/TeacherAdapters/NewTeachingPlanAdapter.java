...
import com.exalogic.inmeghschool.Activities.TeacherActivities.NewTeachingPlanActivity;
import com.exalogic.inmeghschool.Models.TeacherModels.Newteachingplan.NewTeachingPlanData;
...
/**
 * Created by Exalogic on 11-Sep-17.
 */
...
public class NewTeachingPlanAdapter extends RecyclerView.Adapter<NewTeachingPlanAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(NewTeachingPlanAdapter.ViewHolder holder, final int position) {
        ...
        Picasso.with(context).load(Constants.HostImage + newTeachingPlanData.getImage()).resize(50, 50)
